...
import java.awt.*;
    ...
    public class ColourMixer implements AdjustmentListener {

        private static void createAndShowGUI() {
          
          JFrame frame = new JFrame("Colour Mixer using ScrollBar");
          frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
          frame.setBounds(20,30,200,250);
          frame.getContentPane().setLayout(null);
          
          ColourMixer app = new ColourMixer();
          app.sbar1 = new JScrollBar(java.awt.Adjustable.VERTICAL, 127, 5,5,255);
          app.sbar1.setBounds(10,20, 10, 200);
          app.sbar1.setBackground(Color.black);
          ...
          app.sbar2.setBackground(Color.pink);
          ...
          app.sbar3.setBackground(Color.yellow);
